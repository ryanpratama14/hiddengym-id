...
import { PACKAGE_TRANSACTION_SORTERERS, REFETCH_INTERVAL, USER_REDIRECT } from "@/lib/constants";
...
export default function TransactionsProductContainer({ searchParams, lang, t }: Props) {
  ...
  return (
    <section className="grid md:grid-cols-5 gap-6 lg:gap-x-12">
      ...
      <TableSorter redirectTable={redirect} newParams={newParams} sortererData={PACKAGE_TRANSACTION_SORTERERS} />
    </section>
  );
}
