...
import type { PackageCreateInput } from "@router/package";
import type { PlaceList } from "@router/place";
import type { SportList } from "@router/sport";
import type { UserListData } from "@router/user";
